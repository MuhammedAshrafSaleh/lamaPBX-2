...
const Apps = () => {
  ...
  useEffect(() => {
    document.title = `${t('common.menus.apps')} -  LamaPBX`
  ...
  return (
    <>
      ...
      {(data && data[0].total > 0)
        ? <div className='grid content-start grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-5 2k:grid-cols-6 gap-4 px-12 pt-2 grow relative ml-[200px]'>
        ...
        : <div className='grid content-start grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-5 2k:grid-cols-6 gap-4 px-12 pt-2 grow relative overflow-hidden ml-[200px]'>
          {isCurrentWorkspaceEditor
