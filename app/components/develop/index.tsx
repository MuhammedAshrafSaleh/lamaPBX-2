...
const DevelopMain = ({ appId }: IDevelopMainProps) => {
  ...
  return (
    <div className='relative flex flex-col h-full overflow-hidden'>
      <div className='flex items-center flex-shrink-0 px-6 border-b border-solid py-2 border-b-gray-100'>
        <div className='text-lg font-medium text-gray-900'></div>
        <div className='fflex flex-col items-start gap-y-1'>
          ...
          <div className={`flex items-center my-3 h-9 px-3 rounded-lg 
