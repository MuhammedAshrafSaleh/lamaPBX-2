...
const Tooltip: FC<TooltipProps> = ({
  ...
  if (!children) return null; // إخفاء العلامة في حالة عدم وجود children
  ...
  useEffect(() => { isHoverPopupRef.current = isHoverPopup }, [isHoverPopup])
  ...
  useEffect(() => { isHoverTriggerRef.current = isHoverTrigger }, [isHoverTrigger])
